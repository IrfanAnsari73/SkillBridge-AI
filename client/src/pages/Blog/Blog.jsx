...
const blogPosts = [
    ...
    {
        category: "Internship",
        title: "How to Find Your First Internship as a College Student",
        description:
                ...
                <div className="mx-auto max-w-6xl">
                    ...
                    <div className="mb-10 text-center">
                        ...
                        <p className="mx-auto mt-4 max-w-2xl leading-7 text-slate-600">
                            Explore practical guides created to help students
                            build stronger profiles, prepare for opportunities,
                ...
                <div className="mx-auto max-w-5xl">
                    ...
                    <div className="text-center">
                        ...
                        <p className="mx-auto mt-4 max-w-2xl leading-7 text-slate-300">
                            Your career journey becomes easier when learning,
                            projects, resumes, applications, and interview
                    ...
                    <div className="mt-10 grid gap-5 md:grid-cols-3">
                        ...
                        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                            ...
                            <p className="mt-3 leading-7 text-slate-400">
                                Create meaningful projects and organize your
                                achievements into a strong career profile.
                            </p>
                        ...
                        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                            ...
                            <p className="mt-3 leading-7 text-slate-400">
                                Prepare your resume, practice interviews, and
                                apply strategically for internships and jobs.
                            </p>
            ...
            <section className="px-6 py-16">
                ...
                <div className="mx-auto max-w-5xl rounded-3xl bg-green-500 px-6 py-12 text-center shadow-xl md:px-10">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl leading-7 text-slate-900/80">
                        Create your SkillBridge AI profile and bring your
                        resume, skills, projects, certificates, and career
