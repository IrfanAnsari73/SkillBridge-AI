        ...
        <div className="w-full max-w-7xl mx-auto min-w-0 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="rounded-xl bg-white p-5 sm:p-6 shadow">
                    ...
                    <h2 className="mt-3 text-2xl font-bold text-gray-800 break-words">
                        {roadmap.careerGoal}
                    </h2>
                ...
                <div className="mt-5 grid gap-3 md:grid-cols-2">
                    ...
                    {roadmap.recommendedRoles?.map(
                        (role, index) => (
                            <div
                                key={index}
                                className="rounded-lg bg-gray-50 p-4 font-medium text-gray-700 break-words"
                            >
                                {index + 1}. {role}
                            </div>
                        )
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                    ...
                    {roadmap.skillsToLearn?.map(
                        (skill, index) => (
                            <span
                                key={index}
                                className="rounded-full bg-green-100 px-4 py-2 font-medium text-green-700 break-words"
                            >
                                {skill}
                            </span>
                        )
                ...
                <div className="mt-6 space-y-5">
                    ...
                    {roadmap.learningRoadmap?.map(
                        (phase, index) => (
                            <div
                                key={index}
                                className="rounded-xl border-l-4 border-green-600 bg-gray-50 p-4 sm:p-5"
                            >
                ...
                <div className="mt-5 space-y-3">
                    ...
                    {roadmap.careerAdvice?.map(
                        (advice, index) => (
                            <div
                                key={index}
                                className="rounded-lg bg-blue-50 p-4 text-blue-800 break-words"
                            >
                                {index + 1}. {advice}
                            </div>
                        )
